...
SWEP.ReloadHideBoneTables = {
    ...
    [2] = {"tag_clip1"},
    [3] = {"tag_clip", "tag_bullet_deplete_sqtl_00_animate", "tag_bullet_deplete_sqtl_01_animate", "tag_bullet_deplete_sqtl_02_animate", "tag_clip1"}
}
...
local CustomSlotTable = {
    ...
    Category = {"bocw_custom_slot", "bocw_custom_slot_ffar1"},
}
